...
SortBoard is an experimental tool for arranging images, text, and short videos. This first colleague test is about whether the sorting workflow is understandable and usable.
...
**Controls** collects the gestures in one place. In Setup, selecting a card opens its Notes, including prompts and sources. The **Display** section contains card proportions, size, and the option to start sorting in full screen.

All demo images are AI-generated. Closed Sort asks whether images *look* AI-generated, not whether you can distinguish a balanced set of AI and non-AI images. Q-Sort asks for your own judgement from "slop" to "worth keeping"; there is no correct answer.

## Useful feedback

- What did you expect to do first, and was that clear?
- Could you inspect, move, and reconsider every image?
- Did anything happen that you did not expect?
- Did replay match your sorting actions?
- Were the instructions, labels, and export process understandable?

For a problem, include your browser, approximate window size, what you were doing, and a screenshot if useful. Export work you want to keep before clearing browser data. SortBoard has no accounts, automatic submission, or cross-device synchronization.
